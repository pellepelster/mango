...
public class WebHookModuleFactory extends BaseModuleFactory
{
	...
	{
		new WebHookModule(moduleUrl, moduleCallback, parameters);
	}

	@Override
	public boolean supports(String moduleUrl)
	{
		return ModuleUtils.urlContainsModuleId(moduleUrl, WebHookModule.MODULE_ID);
	}
