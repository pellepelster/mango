...
public class DictionaryLabelSearchIndexWebserviceEndpoint {

	private static final String TARGET_NAMESPACE = "http://mango/dictionarylabelsearchindex";

	@org.springframework.beans.factory.annotation.Autowired
	private IXmlVOImporter xmlVOImporter;
	
	@PayloadRoot(localPart = "DictionaryLabelSearchIndex", namespace = TARGET_NAMESPACE)
