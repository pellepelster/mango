...
import io.pelle.mango.server.util.ProxyServletAwareRemoteServiceServlet;
 ...
 * client. For special exception handling you can override the various
 * <code>handle</code>* methods which are invoked by the GWTRPCServiceExporter.
 * 
 * @author George Georgovassilis, g.georgovassilis[at]gmail.com
 * @author Max Jonas Werner
 */
public class GWTRPCServiceExporter extends ProxyServletAwareRemoteServiceServlet implements RPCServiceExporter, ServletContextAware, ServletConfigAware, BeanNameAware {
	...
	/**
	 * Return the set serialization flags (see
	 * {@link AbstractSerializationStream#getFlags()}
	 * 
	 * @return
	 */
	...
	/**
	 * Set serialization flags (see
	 * {@link AbstractSerializationStream#getFlags()}. Default value is
	...
	/**
	 * Post-processes an RPC response. Default method returns the method's
	 * argument
	 * 
	 * @param response
	 *            Response
	...
	/**
	 * Returns the installed serialization policy provider. If none other was
	 * specified, the {@link DefaultSerializationPolicyProvider} is used
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @param service
	 *            Service to which the decoded requests are forwarded
	 */
