...
public class MangoClientSyncWebTest {
	...
	private JunitLayoutFactory layoutFactory;

	private MangoClientSyncWebTest() {
		this.layoutFactory = new JunitLayoutFactory();
	...
	public <VOTYPE extends IBaseVO> DictionaryEditorModuleTestUI<VOTYPE> openEditor(final EditorModel<VOTYPE> editorModel) {
		final AsyncCallbackFuture<IModuleUI> future = AsyncCallbackFuture.create();
	...
	public <VOTYPE extends IBaseVO> DictionaryEditorModuleTestUI<VOTYPE> openEditor(final IDictionaryModel dictionaryModel, long id) {
		final AsyncCallbackFuture<IModuleUI> future = AsyncCallbackFuture.create();
