...
public class DictionarySearchModuleTestUIFactory extends BaseModuleUIFactory<Object, DictionarySearchModuleTestUI> {
	...
	@Override
	public void getNewInstance(final String moduleUrl, final AsyncCallback<DictionarySearchModuleTestUI> moduleCallback, Map<String, Object> parameters, final Optional<IModuleUI<?, ?>> previousModuleUI) {
