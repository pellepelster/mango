...
class DictionaryNavigationGenerator {
	...
	public class «navigationNode.navigationNodeClassName» extends «NavigationTreeElement.name» {
		...
		public «navigationNode.navigationNodeClassName»() {
			...
			setModuleLocator("«IModuleUI.UI_MODULE_ID_PARAMETER_NAME»=DictionaryEditor&" + io.pelle.mango.client.modules.BaseDictionaryEditorModule.EDITORDICTIONARYNAME_PARAMETER_ID + "=«ModelUtil.getParentDictionary(navigationNode.dictionaryEditor).name»");
			«ELSEIF navigationNode.dictionarySearch != null»
			setModuleLocator("«IModuleUI.UI_MODULE_ID_PARAMETER_NAME»=DictionarySearch&" + io.pelle.mango.client.modules.BaseDictionarySearchModule.SEARCHDICTIONARYNAME_PARAMETER_ID + "=«ModelUtil.getParentDictionary(navigationNode.dictionarySearch).name»");
