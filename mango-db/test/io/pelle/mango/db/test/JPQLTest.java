...
public class JPQLTest extends TestCase {
	...
	public void testJoin() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).join(DBTest1.TEST2S);
		assertEquals("SELECT x0 FROM DBTest1 x0 LEFT JOIN x0.test2s x1", query.getJPQL(EntityVOMapper.INSTANCE));
	}

	@Test
	public void testJoin1() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).join(DBTest1.TEST2S, DBTest2.TEST3);
	...
	public void testSelectAll() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class);
		assertEquals("SELECT x0 FROM DBTest1 x0", query.getJPQL(EntityVOMapper.INSTANCE));
	}

	@Test
	public void testCriteria() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1));
		assertEquals("SELECT x0 FROM DBTest1 x0 WHERE x0.id = 1", query.getJPQL(EntityVOMapper.INSTANCE));
	}

	@Test
	public void testCriteriaAndOr() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1).and(DBTest1.ID.eq(2).or(DBTest1.ID.eq(3))));
	...
	public void testCriteriaAndNestedOr() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1).and(or(DBTest1.ID.eq(2), DBTest1.ID.eq(3))));
		assertEquals("SELECT x0 FROM DBTest1 x0 WHERE x0.id = 1 AND (x0.id = 2 OR x0.id = 3)", query.getJPQL(EntityVOMapper.INSTANCE));
	}

	@Test
	public void testCriteriaOrNestedAnd() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1).or(and(DBTest1.ID.eq(2), DBTest1.ID.eq(3))));
	...
	public void testCriteriaOr() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1).or(DBTest1.ID.eq(2)));
	...
	public void testCriteriaAnd() {
		SelectQuery<DBTest1> query = selectFrom(DBTest1.class).where(DBTest1.ID.eq(1).and(DBTest1.ID.eq(2)));
	...
	public void testEntityCriteria() {
		...
		SelectQuery<DBTest2> query = selectFrom(DBTest2.class).where(DBTest2.TEST3.eq(test3));
	...
	public void testSelectCount() {
		...
		assertEquals("SELECT COUNT(x0) FROM DBTest1 x0", query.getJPQL(EntityVOMapper.INSTANCE));
	}
