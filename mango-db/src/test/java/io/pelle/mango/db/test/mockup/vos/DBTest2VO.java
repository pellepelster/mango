...
public class DBTest2VO extends BaseVO {
	...
	public static final IEntityDescriptor<DBTest2VO> DB_TEST2 = new EntityDescriptor<DBTest2VO>(DBTest2VO.class, null, null, null);
	...
	public void setTest3(DBTest3VO test3) {
		getMetadata().addChange("test3", test3);
