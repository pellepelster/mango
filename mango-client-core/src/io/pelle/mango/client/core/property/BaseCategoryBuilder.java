...
public abstract class BaseCategoryBuilder {
	...
	public PropertyCategoryBuilder createCategory(String categoryName) {
		...
		Optional<PropertyCategory> optionalCategory = null; //Iterables.tryFind(category.getPropertyCategories(), PropertyService1.categoryByName(categoryName));
