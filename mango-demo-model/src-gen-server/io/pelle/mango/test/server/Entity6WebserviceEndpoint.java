...
public class Entity6WebserviceEndpoint {

	private static final String TARGET_NAMESPACE = "http://mangodemo/entity6";

	@org.springframework.beans.factory.annotation.Autowired
	private IXmlVOImporter xmlVOImporter;
	
	@PayloadRoot(localPart = "Entity6", namespace = TARGET_NAMESPACE)
