...
public class Entity5WebserviceEndpoint {

	private static final String TARGET_NAMESPACE = "http://mangodemo/entity5";

	@org.springframework.beans.factory.annotation.Autowired
	private IXmlVOImporter xmlVOImporter;
	
	@PayloadRoot(localPart = "Entity5", namespace = TARGET_NAMESPACE)
